...
server.tool('ocr_for_local_pdf', 'Performs OCR on a local PDF file by uploading it to Mistral API.', {
...
server.tool('ocr_for_pdf_url', 'Performs OCR on a PDF file from a public URL.', {
